...
public CubeBehavior cubeBehavior;
	...
	void ProccessKeyboardInput(){
		if(Input.GetKeyDown (KeyCode.DownArrow)){	
				...
				//Move(GameObject pusherCube2, pusherCube2.GetComponent<PusherCubeScript>().x,pusherCube2.GetComponent<PusherCubeScript>().y); );
			}
	...
	obj.transform.position += new Vector3(xDir, yDir, 10);	
	}
}
